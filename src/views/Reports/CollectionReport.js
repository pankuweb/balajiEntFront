            ...
            <Page size="A4" style={styles.page} wrap>
                <View style={styles.section}>
                        ...
                        ? Loans?.map((item, index) => {
                              return (
                                  <View style={styles.tableRow1}>
                                      ...
                                      <Text break style={styles.th}>{`${item?.customer}`}</Text>
                    ...
                    <View style={styles.tableRow1}>
                        ...
                        <Text break style={styles.th}>
                            {Loans?.reduce((accumulator, current) => accumulator + current.paidInstallments, 0)}
                        </Text>
                    </View>
                </View>
            </Page>
...
export default function CollectionReport(props) {
    return (
        <React.Fragment>
