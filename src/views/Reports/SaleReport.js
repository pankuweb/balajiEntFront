...
const MyDocument = (props) => {
    ...
    const TotalDownPayments = Loans?.reduce((accumulator, current) => accumulator + current.downPayment, 0);
    const TotalLoanAmounts = Loans?.reduce(
        (accumulator, current) => accumulator + (current.loanAmount / 100) * current.interest + current.loanAmount,
        0
    );
    const TotalPendingAmount = Loans?.reduce((accumulator, current) => accumulator + current.pendingPayment, 0);
    return (
        <Document>
            <Page size="A4" style={styles.page} wrap>
                <View style={styles.section}>
                    ...
                    {/* <View style={styles.tableRow1}>
                        ...
                        <Text break style={styles.space}></Text>
                        <Text break style={styles.space}></Text>
                        <Text break style={styles.space}>Total Down Payments</Text>
                        <Text break style={styles.th}>{TotalDownPayments}</Text>
                    </View> */}
                    <View style={styles.tableRow1}>
                        <Text break style={styles.space}></Text>
                        <Text break style={styles.space}></Text>
                        <Text break style={styles.space}></Text>
                        <Text break style={styles.space}>
                            Total Loan Amounts(Interest Included)
                        </Text>
                        <Text break style={styles.th}>
                            {TotalLoanAmounts}
                        </Text>
                    ...
                    {/* <View style={styles.tableRow1}>
                        ...
                        <Text break style={styles.space}></Text>
                        <Text break style={styles.space}></Text>
                        <Text break style={styles.space}>Total Pending Amounts</Text>
                        <Text break style={styles.th}>{TotalPendingAmount}</Text>
                    </View> */}
                </View>
            </Page>
        </Document>
