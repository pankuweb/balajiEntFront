            ...
            <Page size="A4" style={styles.page} wrap>
                <View style={styles.section}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <Text style={styles.th}>Recieved Installment</Text>
                    ...
                    <View style={styles.tableRow1}>
                        ...
                        <Text break style={styles.th}>
                            {Loans?.reduce((accumulator, current) => accumulator + current.EMI_Pending, 0)}
                        </Text>
                    </View>
                </View>
            </Page>
...
export default function OverdueReport(props) {
    return (
        <React.Fragment>
